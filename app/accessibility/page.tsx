    ...
    <div className="flex flex-col">
      ...
      <section className="py-16 md:py-24 px-6 border-b border-neutral-200 dark:border-neutral-800">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Accessibility</h1>
          <p className="text-neutral-600 dark:text-neutral-400">Our commitment to making Cursor Boston accessible to everyone</p>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 px-6">
        <div className="max-w-3xl mx-auto prose dark:prose-invert prose-neutral">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Conformance Status</h2>
          <p className="text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Accessibility Features</h2>

          <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">Navigation</h3>
          ...
          <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">Visual Design</h3>
          <ul className="list-disc list-inside text-neutral-300 space-y-2 mb-6">
          ...
          <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">Forms & Interactions</h3>
          <ul className="list-disc list-inside text-neutral-300 space-y-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Assistive Technologies</h2>
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Known Limitations</h2>
          <ul className="list-disc list-inside text-neutral-300 space-y-2 mb-6">
            <li><strong className="text-foreground">Third-party content:</strong> Some embedded widgets may not be fully accessible</li>
            <li><strong className="text-foreground">User-generated content:</strong> May not always meet accessibility guidelines</li>
          </ul>

          <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Event Accessibility</h2>
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Feedback</h2>
          <p className="text-neutral-300 mb-6">
