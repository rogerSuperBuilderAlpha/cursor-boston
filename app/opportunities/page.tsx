          ...
          {opportunitiesData.opportunities.length > 0 ? (
            <div className="grid gap-8">
              {opportunitiesData.opportunities.map((opp) => (
                <div
                  key={opp.id}
                  className="bg-neutral-100 dark:bg-neutral-900 rounded-2xl overflow-hidden border border-neutral-200 dark:border-neutral-800"
                >
                  <div className="p-8">
                    {/* Header */}
                      ...
                      <div className="mb-6">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                          {opp.team.map((member) => (
                            <div
                              key={member.name}
                              className="p-4 bg-neutral-200 dark:bg-neutral-800/50 rounded-xl border border-neutral-300 dark:border-neutral-700/50"
                            >
