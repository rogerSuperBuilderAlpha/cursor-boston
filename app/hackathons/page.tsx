    ...
    <div className="flex flex-col">
      ...
      <section className="py-12 px-6 border-b border-neutral-200 dark:border-neutral-800">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-neutral-500 dark:text-neutral-400">
            ...
            <Link href="/events" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 underline">
              Events
            </Link>{" "}
            for upcoming dates.
          </p>
      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="list-disc list-inside text-neutral-500 dark:text-neutral-400 space-y-2">
