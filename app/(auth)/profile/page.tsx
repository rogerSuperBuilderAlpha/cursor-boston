          ...
          <div className="space-y-6">
            ...
            <div className="bg-neutral-900 rounded-2xl p-6 border border-neutral-800">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                >
                  <div className="w-10 h-10 bg-emerald-500/10 rounded-lg flex items-center justify-center">
                    <LayersIcon className="text-emerald-400" />
                  </div>
                  <div>
              ...
              <div className="bg-neutral-900 rounded-2xl p-6 border border-neutral-800">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-lg font-semibold text-white flex items-center gap-2">
                    <UserCardIcon className="text-purple-400" />
                    Your AI Agents
                  </h2>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    {connectedAgents.length > 0 && (
                      <div className="flex items-center gap-1 px-2 py-1 bg-purple-500/10 rounded-lg">
                        <UserCardIcon size={14} className="text-purple-400" />
                        ...
                        >
                          <div className="w-8 h-8 rounded-full bg-purple-500/20 flex items-center justify-center flex-shrink-0">
                            {agent.avatarUrl ? (
                              ...
                              <UserCardIcon size={16} className="text-purple-400" />
                            )}
                          </div>
                          <div className="flex-1 min-w-0">
