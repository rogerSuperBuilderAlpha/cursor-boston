    ...
    <main className="flex flex-col">
      ...
      <section className="py-12 md:py-16 px-6">
        <div className="max-w-3xl mx-auto prose dark:prose-invert prose-neutral">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Data Sharing</h2>
          <p className="text-neutral-700 dark:text-neutral-300 mb-4">We do not sell your personal information. We may share information with:</p>
          <ul className="list-disc list-inside text-neutral-700 dark:text-neutral-300 space-y-2 mb-6">
          ...
          <p className="text-neutral-700 dark:text-neutral-300 mb-4">You have the right to:</p>
          <ul className="list-disc list-inside text-neutral-700 dark:text-neutral-300 space-y-2 mb-6">
