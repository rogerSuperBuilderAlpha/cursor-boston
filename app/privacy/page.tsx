...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Cursor Boston - Learn how we collect, use, and protect your personal information.",
};
      ...
      <section className="py-12 md:py-16 px-6">
        <div className="max-w-3xl mx-auto prose prose-invert prose-neutral">
          ...
          <p className="text-neutral-300 mb-6">
            ...
            from those services, such as your username and profile information, to enhance your
            Cursor Boston experience.
          </p>
          ...
          <ul className="list-disc list-inside text-neutral-300 space-y-2 mb-6">
            ...
            <li>Event hosts and partners, but only the information necessary for event coordination</li>
          ...
          <p className="text-neutral-300 mb-6">
            ...
            preferences, and analyze site usage. You can control cookies through your browser settings.
          </p>
