    ...
    <div className="flex flex-col">
      ...
      <section className="py-12 md:py-16 px-6">
        <div className="max-w-3xl mx-auto prose dark:prose-invert prose-neutral">
          ...
          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Information We Collect</h2>

          <h3 className="text-xl font-semibold text-black dark:text-white mb-3 mt-6">Information You Provide</h3>
          ...
          <h3 className="text-xl font-semibold text-black dark:text-white mb-3 mt-6">Information Collected Automatically</h3>
          <ul className="list-disc list-inside text-neutral-600 dark:text-neutral-300 space-y-2 mb-6">
          ...
          <h3 className="text-xl font-semibold text-black dark:text-white mb-3 mt-6">Third-Party Services</h3>
          <p className="text-neutral-600 dark:text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">How We Use Your Information</h2>
          <ul className="list-disc list-inside text-neutral-600 dark:text-neutral-300 space-y-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Data Sharing</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-4">We do not sell your personal information. We may share information with:</p>
          <ul className="list-disc list-inside text-neutral-600 dark:text-neutral-300 space-y-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Data Security</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-6">
            We implement appropriate technical and organizational measures to protect your personal
            information. However, no method of transmission over the Internet is 100% secure.
          </p>

          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Your Rights</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-4">You have the right to:</p>
          <ul className="list-disc list-inside text-neutral-600 dark:text-neutral-300 space-y-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Cookies</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-6">
            We use cookies to maintain your session, remember preferences, and analyze site usage.
            See our{" "}
            <Link href="/cookies" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300">
              Cookie Policy
            </Link>{" "}
            for more details.
          </p>

          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Children&apos;s Privacy</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-6">
            Our services are not intended for individuals under the age of 13. We do not knowingly
            collect personal information from children under 13.
          </p>

          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Changes to This Policy</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-6">
          ...
          <div className="mt-12 pt-8 border-t border-neutral-200 dark:border-neutral-800">
            <p className="text-neutral-500 dark:text-neutral-400 text-sm">
              ...
              {" | "}
              <Link href="/cookies" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300">Cookie Policy</Link>
              {" | "}
