    ...
    <div className="flex flex-col">
      ...
      <section className="py-12 md:py-16 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl p-6 md:p-8 mb-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-neutral-600 dark:text-neutral-300">
                  Cursor Boston is an <strong className="text-black dark:text-white">independent, volunteer-run
          ...
          {/* Key Points */}
          <div className="prose dark:prose-invert prose-neutral mb-8">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Key Points</h2>

            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <span className="text-emerald-600 dark:text-emerald-400 font-bold text-lg">1.</span>
                <p className="text-neutral-600 dark:text-neutral-300 m-0">
                  <strong className="text-black dark:text-white">We are part of the Cursor Ambassadors Program</strong> —
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-neutral-600 dark:text-neutral-300 m-0">
                  <strong className="text-black dark:text-white">We operate independently</strong> —
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-neutral-600 dark:text-neutral-300 m-0">
                  <strong className="text-black dark:text-white">Our partners support our community</strong> —
              ...
              <div className="flex items-start gap-3">
                <span className="text-emerald-600 dark:text-emerald-400 font-bold text-lg">4.</span>
                <p className="text-neutral-600 dark:text-neutral-300 m-0">
                  <strong className="text-black dark:text-white">&quot;Cursor&quot; is a trademark of Anysphere Inc.</strong> —
          ...
          <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-6 md:p-8 mb-8">
            ...
            <Link
              href="/about-cursor"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-500 text-black dark:text-white rounded-lg font-semibold hover:bg-emerald-400 transition-colors"
            >
          ...
          <div className="prose dark:prose-invert prose-neutral">
            <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Legal Disclaimer</h2>
          ...
          <div className="mt-12 pt-8 border-t border-neutral-200 dark:border-neutral-800">
            ...
            <p className="text-neutral-500 dark:text-neutral-400 text-sm">
              See also:{" "}
              <Link href="/about-cursor" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300">
                About Cursor & Our Affiliation
              </Link>
              {" | "}
