        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {eventTypes.map((type) => (
              <div
                key={type.name}
                className="flex items-start gap-4 p-4 bg-neutral-100 dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800"
              >
                <div className="text-neutral-500 dark:text-neutral-400">{type.icon}</div>
                <div>
                  <h3 className="text-black dark:text-white font-medium mb-1">{type.name}</h3>
                  <p className="text-neutral-500 dark:text-neutral-400 text-sm">{type.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          {eventsData.upcoming.length > 0 ? (
              ...
              {eventsData.upcoming.map((event) => (
                ...
                >
                  <div className="grid md:grid-cols-2 gap-0">
                    {/* Event Image */}
                    <div className="relative aspect-[9/16] md:aspect-auto md:min-h-[400px] bg-neutral-200 dark:bg-neutral-800">
                      <Image
                        src={event.image}
                        alt={event.title}
                        fill
                    ...
                    <div className="p-8 flex flex-col justify-center">
                        ...
                        <div className="mb-6">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {event.topics.map((topic) => (
                              <span
                                key={topic}
                                className="px-3 py-1 bg-neutral-200 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 text-sm rounded-full"
                              >
                                {topic}
                              </span>
                            ))}
                      ...
                      <div className="flex flex-col sm:flex-row gap-3">
                        <a
                          ...
                          className="inline-flex items-center justify-center gap-2 px-6 py-3 md:px-8 md:py-4 bg-black dark:bg-white text-white dark:text-black rounded-lg text-base font-semibold hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-black w-full sm:w-auto"
                        >
                          View Details
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="bg-neutral-100 dark:bg-neutral-900 rounded-2xl p-12 text-center border border-neutral-200 dark:border-neutral-800">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-black dark:text-white hover:underline focus-visible:outline-none focus-visible:underline"
              >
