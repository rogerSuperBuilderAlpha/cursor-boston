              ...
              {posts.map((post) => (
                ...
                >
                  <div className="flex items-center gap-4 text-sm text-neutral-500 mb-4">
                    ...
                    <Link href={`/blog/${post.slug}`} className="block group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-neutral-900 rounded-lg">
                    <h2 className="text-2xl font-bold text-black dark:text-white mb-3 group-hover:text-neutral-600 dark:group-hover:text-neutral-300 transition-colors">
                      {post.title}
                    </h2>
                    <p className="text-neutral-400 leading-relaxed mb-4">
                      {post.excerpt}
                    </p>
                    <span className="text-black dark:text-white font-medium group-hover:underline">
