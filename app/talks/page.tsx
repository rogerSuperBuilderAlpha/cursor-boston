        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {talksData.categories.map((category) => (
              ...
              >
                <h3 className="text-black dark:text-white font-medium mb-2">{category.name}</h3>
          ...
          {talksData.talks.length > 0 ? (
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {talksData.talks.map((talk: {
                ...
                <div
                  key={talk.id}
                  className="bg-neutral-100 dark:bg-neutral-900 rounded-2xl overflow-hidden border border-neutral-200 dark:border-neutral-800 hover:border-neutral-300 dark:border-neutral-700 transition-colors"
                >
                  <div className="p-6">
                    <span className="inline-block px-2 py-1 bg-neutral-200 dark:bg-neutral-800 text-neutral-500 dark:text-neutral-400 text-xs font-medium rounded mb-3 capitalize">
                      {talk.category}
                    </span>
                    ...
                    {talk.videoUrl && (
                      <a
                        ...
                        className="inline-flex items-center gap-2 text-black dark:text-white text-sm font-medium hover:underline focus-visible:outline-none focus-visible:underline"
                      >
                        Watch Recording
                        <svg
      ...
      <section className="py-16 px-6 bg-neutral-50 dark:bg-neutral-950">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-neutral-500 dark:text-neutral-400 mb-8">
            <strong className="text-black dark:text-white">All skill levels are welcome</strong>{" "}
          ...
          <div className="bg-neutral-100 dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-800 mb-8">
            <h3 className="text-black dark:text-white font-medium mb-3">Talk ideas include:</h3>
