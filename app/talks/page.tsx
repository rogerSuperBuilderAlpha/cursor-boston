          ...
          {talksData.talks.length > 0 ? (
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {talksData.talks.map((talk: {
                ...
                >
                  <div className="p-6">
                    <span className="inline-block px-2 py-1 bg-neutral-800 text-neutral-400 text-xs font-medium rounded mb-3 capitalize">
                      {talk.category}
                    </span>
                    ...
                    {talk.videoUrl && (
                      <a
                        ...
                        className="inline-flex items-center gap-2 text-white text-sm font-medium hover:underline focus-visible:outline-none focus-visible:underline"
                      >
                        Watch Recording
                        <svg
      ...
      <section className="py-16 px-6 bg-neutral-950">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-neutral-400 mb-8">
            <strong className="text-white">All skill levels are welcome</strong>{" "}
          ...
          <div className="bg-neutral-900 rounded-xl p-6 border border-neutral-800 mb-8">
            <h3 className="text-white font-medium mb-3">Talk ideas include:</h3>
