...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      <section className="py-16 md:py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href="/events"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 md:px-8 md:py-4 border border-neutral-300 dark:border-neutral-700 text-black dark:text-white rounded-lg text-base font-semibold hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-black"
            >
              View Events
            </Link>
          </div>
      ...
      <section className="py-16 md:py-20 px-6 bg-neutral-100 dark:bg-neutral-950">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-10">
            ...
            <Link
              href="/events"
              className="text-neutral-600 dark:text-neutral-300 hover:text-black dark:hover:text-white transition-colors text-sm font-medium focus-visible:outline-none focus-visible:text-black dark:focus-visible:text-white focus-visible:underline"
            >
              See all events &rarr;
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            {/* Event Poster */}
            <div className="relative aspect-[9/16] max-h-[500px] rounded-2xl overflow-hidden bg-neutral-200 dark:bg-neutral-900">
              <Image
              ...
              />
              {/* QR Code Overlay */}
              <div className="absolute bottom-[2%] right-[3%] w-[15%] aspect-square bg-white dark:bg-neutral-800 p-1 rounded">
                <Image
                  src="/luma-qr.png"
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  <span className="px-2 py-1 bg-neutral-200 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 text-xs rounded-full">
                    Cursor Credits
                  </span>
                  <span className="px-2 py-1 bg-neutral-200 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 text-xs rounded-full">
                    Stickers
              ...
              <div
                ...
                className={`rounded-xl p-5 border transition-all ${
                  card.highlight
                    ...
                    : "bg-neutral-100 dark:bg-neutral-900/50 border-neutral-200 dark:border-neutral-800 hover:border-emerald-500/30 hover:bg-neutral-200 dark:hover:bg-neutral-900"
                }`}
              >
      ...
      {/* Community Section */}
      <section className="py-16 md:py-20 px-6 bg-neutral-200 dark:bg-neutral-950">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-black dark:text-white mb-4">
            Join Our Community
          </h2>
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-3 px-6 py-3 md:px-8 md:py-4 bg-[#5865F2] text-white rounded-lg text-base font-semibold hover:bg-[#4752C4] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#5865F2] focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-black"
          >
            <svg
              width="24"
              height="24"
