    ...
    <div className="flex flex-col">
      ...
      <section className="py-16 md:py-24 px-6 border-b border-neutral-200 dark:border-neutral-800">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold text-black dark:text-white mb-4">Terms of Service</h1>
      ...
      <section className="py-12 md:py-16 px-6">
        <div className="max-w-3xl mx-auto prose dark:prose-invert prose-neutral">
          ...
          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Description of Services</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-4">Cursor Boston provides:</p>
          ...
          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">User Accounts</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-4">When you create an account, you agree to:</p>
          <ul className="list-disc list-inside text-neutral-600 dark:text-neutral-300 space-y-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Community Guidelines</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-4">As a member, you agree to:</p>
          <ul className="list-disc list-inside text-neutral-600 dark:text-neutral-300 space-y-2 mb-6">
          ...
          <p className="text-neutral-600 dark:text-neutral-300 mb-6">
            See our full{" "}
            <Link href="/code-of-conduct" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300">
              Code of Conduct
            </Link>{" "}
            for detailed community guidelines.
          </p>

          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Events and Venues</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-4">By attending events, you agree to:</p>
          <ul className="list-disc list-inside text-neutral-600 dark:text-neutral-300 space-y-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Intellectual Property</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Disclaimers</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Limitation of Liability</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Termination</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-6">
          ...
          <h2 className="text-2xl font-bold text-black dark:text-white mb-4 mt-8">Governing Law</h2>
          <p className="text-neutral-600 dark:text-neutral-300 mb-6">
          ...
          <div className="mt-12 pt-8 border-t border-neutral-200 dark:border-neutral-800">
            <p className="text-neutral-500 dark:text-neutral-400 text-sm">
              ...
              {" | "}
              <Link href="/disclaimer" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300">Disclaimer</Link>
            </p>
          </div>
        </div>
      </section>
