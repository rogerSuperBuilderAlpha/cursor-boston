    ...
    <div className="flex flex-col">
      ...
      <section className="py-16 md:py-24 px-6 border-b border-neutral-200 dark:border-neutral-800">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-neutral-600 dark:text-neutral-400">Last updated: January 2026</p>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 px-6">
        <div className="max-w-3xl mx-auto prose dark:prose-invert prose-neutral">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Description of Services</h2>
          <p className="text-neutral-700 dark:text-neutral-300 mb-4">Cursor Boston provides:</p>
          ...
          <p className="text-neutral-700 dark:text-neutral-300 mb-4">When you create an account, you agree to:</p>
          <ul className="list-disc list-inside text-neutral-700 dark:text-neutral-300 space-y-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Community Guidelines</h2>
          <p className="text-neutral-700 dark:text-neutral-300 mb-4">As a member, you agree to:</p>
          <ul className="list-disc list-inside text-neutral-700 dark:text-neutral-300 space-y-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Events and Venues</h2>
          <p className="text-neutral-700 dark:text-neutral-300 mb-4">By attending events, you agree to:</p>
          <ul className="list-disc list-inside text-neutral-700 dark:text-neutral-300 space-y-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-4 mt-8">Disclaimers</h2>
          <p className="text-neutral-700 dark:text-neutral-300 mb-6">
